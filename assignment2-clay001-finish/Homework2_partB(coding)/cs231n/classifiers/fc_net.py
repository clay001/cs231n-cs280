...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        new_x = np.reshape(X,[batch_size,-1])
        
        fc1_out, fc1_cache = affine_forward(new_x,self.params['W1'],self.params['b1'])
        
        relu1_out, relu_cache = relu_forward(fc1_out)
        
        fc2_out, fc2_cache = affine_forward(relu1_out,self.params['W2'],self.params['b2'])
        ...
        grads['W2'] = self.reg*self.params['W2']+dw2   #更新的时候为什么要正则化W
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # my way can't work ,don't know why
        fc_cache = {}
        relu_cache = {}
        bn_cache = {}
        dropout_cache = {}
